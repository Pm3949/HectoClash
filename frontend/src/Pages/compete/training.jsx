...
const Training = () => {
    ...
    const disableSubmit = currentNumberIndex < numbers.length || 
                         validationError || 
                         !expression;
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            <div className="lg:w-3/4 flex flex-col gap-8">
              <div className="bg-gray-800 rounded-lg p-6">
                <h2 className="text-xl font-bold text-white mb-2">Sequence: {currentProblem.title}</h2>
              ...
              <div className="bg-gray-800 rounded-lg p-6">
                ...
                <div className="mb-4">
                  <button
                    ...
                    tabIndex={currentNumberIndex >= numbers.length || (expression.length > 0 && /\d/.test(expression.slice(-1))) ? -1 : 0}
                    disabled={currentNumberIndex >= numbers.length || (expression.length > 0 && /\d/.test(expression.slice(-1)))}
                    className={`w-full py-3 mb-4 rounded-lg ${
                      currentNumberIndex >= numbers.length || (expression.length > 0 && /\d/.test(expression.slice(-1)))
              ...
              <div className="flex justify-end gap-4 mt-4">
                ...
                <button
                  ...
                  tabIndex={0}
                  className="bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-6 rounded-lg focus:ring-2 focus:ring-red-400 focus:outline-none transition-colors"
                >
                  Give Up
                </button>
              </div>
